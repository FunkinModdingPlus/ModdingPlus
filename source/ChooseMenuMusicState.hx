...
class ChooseMenuMusicState extends MusicBeatState
{
	var addCharUi:FlxUI;
	...
	override function create()
	{
		...
		var chosenMenuMusic = 'None';
		var choseMenuMusic:Bool = false;
		add(bg);
		...
		/*add(mainPngButton);*/
		finishButton = new FlxButton(FlxG.width - 170, FlxG.height - 50, "Confirm", function():Void {
			writeCharacters();
	...
	function writeCharacters() {
		...
		var epicCustomMenuSoundsFile:Dynamic =CoolUtil.parseJson(Assets.getText('assets/music/custom_menu_music/custom_menu_music.json'));
		trace("parsed");
		Reflect.setField(epicCustomMenuSoundsFile,likeText.text,nameText.text);*/
		var chosenMenuMusic = nameText.text;
