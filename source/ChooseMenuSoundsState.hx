...
class ChooseMenuSoundsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		optionList = [
						...
						{name: "New Menu Sound...", value: false},
						{name: "Sort...", value: false},
						{name: "Choose Menu Sounds...", value: false}
					];
		...
		if (controls.ACCEPT) {
			if (saves.members[curSelected].beingSelected) {
				...
				switch (optionList[optionsSelected].name) {
					...
					case "New Menu Sound...":
						saveOptions();
						FlxG.switchState(new NewMenuSoundState());
					case "Sort...":
						saveOptions();
