...
class MainMenuState extends MusicBeatState
{
	...
	var chosenMenuMusic:Array<String>;
	var choseMenuMusic:Bool;
	...
	override function create()
	{
		...
		if (!FlxG.sound.music.playing)
		{
			if (!choseMenuMusic) {
				...
				FlxG.sound.playMusic('assets/music/custom_menu_music/'+CoolUtil.parseJson(File.getContent("assets/music/custom_menu_music/custom_menu_music.json")).Menu+chosenMenuMusic);
			}
		...
		versionShit.setFormat("assets/fonts/"+CoolUtil.parseJson(File.getContent("assets/data/options.json")).Font, 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		usingSave.scrollFactor.set();
		usingSave.setFormat("assets/fonts/"+CoolUtil.parseJson(File.getContent("assets/data/options.json")).Font, 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
		if (OptionsHandler.options.useSaveDataMenu)
			add(usingSave);
						...
						else
						{
							FlxFlicker.flicker(spr, 1, 0.06, false, false, function(flick:FlxFlicker)
							{
								...
								switch (daChoice)
								{
									...
									/*case 'M+ Options':
										FlxG.switchState(new MoptionsState());*/
								}
							});
						}
					});
