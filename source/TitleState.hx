...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		var logo:FlxSprite = new FlxSprite().loadGraphic(Paths.image('logo', 'preload'));
		logo.screenCenter();
		...
		coolDudes = Assets.getText(Paths.txt('creators', 'preload')).split("\n");
		trace(coolDudes);
	...
	{
		var fullText:String = Assets.getText(Paths.txt('introText', 'preload'));
